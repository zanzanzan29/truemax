...
@WebServlet(urlPatterns = "/paymentVNPay")
public class PaymentVNPServlet extends HttpServlet {
    private long total;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (bankCode != null && !bankCode.isEmpty()) {
            vnp_Params.put("bankcode", bankCode);
        }
        vnp_Params.put("vnp_TxnRef", vnp_TxnRef);
        vnp_Params.put("vnp_OrderInfo", req.getParameter("address"));
