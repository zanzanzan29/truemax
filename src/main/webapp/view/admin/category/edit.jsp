...
<%@include file="/templates/admin/inc/header.jsp"%>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <c:if test="${error == '1'}">
            <p class="errors">Edit category failed!!!</p>
        </c:if>
    <div class="row mt-3">
      <div class="col-lg-6 cachle">
         <div class="card">
           ...
           <c:if test="${error == null || error.equals('1')}">
            <input type="text" class="form-control" id="input-1" name="category_name" placeholder="Enter the category name" value="${category.category_name}">
           </c:if>
           <c:if test="${error.equals('2')}">
               <input type="text" class="form-control" id="input-1" name="category_name" style="border: 2px solid red;" placeholder="Enter the category name" value="${category.category_name}">
