...
<meta charset="UTF-8">
  <div class="content-wrapper">
    <div class="container-fluid">
        ...
        <c:if test="${error == '1'}">
            <p class="errors">Add Shop failed!!!</p>
        </c:if>
    <div class="row mt-3">
           ...
           <hr>
            ...
            <div class="form-group">
                ...
                <select name="id_user" id="id_user">
                    <c:forEach var="userNS" items="${listUserNS}">
                         <option value="${userNS.id}" <c:if test="${shop.users.id == userNS.id}">selected</c:if>>${userNS.username}</option>
                    </c:forEach>
                </select>
            </div>
           <div class="form-group">
