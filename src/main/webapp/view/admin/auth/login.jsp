		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="/templates/admin/assets/images/logo-icon.png" alt="logo icon">
		 	</div>
		  <div class="card-title text-uppercase text-center py-3">Log in</div>
             <c:set var="error" value="${param.err}"/>
             <c:if test="${error == '1'}">
                 <p class="errors" style="color: red">Incorrect username or password!!!</p>
             </c:if>
		    <form method="post">
			...
			<div class="form-row">
			 ...
			 <div class="form-group col-6 text-right">
			  <a href="/view/admin/reset-password.jsp">Forgot password</a>
			 </div>
			</div>
			 <button type="submit" class="btn btn-light btn-block">Log in</button>
			  <div class="text-center mt-3">Login with</div>
